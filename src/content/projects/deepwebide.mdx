...
stack: ["React", "TypeScript", "Vite", "Spring Boot", "Java 17", "WebSocket", "YJS", "Redis", "MySQL", "Docker", "Nginx", "AWS", "GitHub Actions", "Sentry", "Coolsms"]
links:
...
youtube: "lbqJ4ukX_KE?si=KbH7eBvt-KgIy8B2"
order: 2
---
